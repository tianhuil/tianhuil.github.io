...
Overall, RTK reduced token cost by about **4%** (which is statistically significant). The aggregate result is useful, but the breakdown explains where it comes from.
