...
GPT-5.6 was recently released and has gained widespread interest.    It comes with three "capability tiers": Sol, Terra, and Luna with each tier offer reasoning-effort setting: `non-reasoning` , `low`, `medium`, `high`, `xhigh`, or `max`.

That gives us a fairly large menu of models and naturally begs the question: should you increase reasoning effort, or move up to a more capable tier? I looked at an Artificial Analysis snapshot to compare the options.
